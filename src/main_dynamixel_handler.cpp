...
DynamixelHandler::DynamixelHandler() : Node("dynamixel_handler", rclcpp::NodeOptions()
    ...
    if ( num_[SERIES_X] > 0 ) {
        sub_ctrl_x_pos_  = create_subscription<DynamixelControlXPosition>        ("dynamixel/x_cmd/position",          4, bind(&DynamixelHandler::CallBackDxlCmd_X_Position, this, _1));
        sub_ctrl_x_vel_  = create_subscription<DynamixelControlXVelocity>        ("dynamixel/x_cmd/velocity",          4, bind(&DynamixelHandler::CallBackDxlCmd_X_Velocity, this, _1));
        sub_ctrl_x_cur_  = create_subscription<DynamixelControlXCurrent>         ("dynamixel/x_cmd/current",           4, bind(&DynamixelHandler::CallBackDxlCmd_X_Current, this, _1));
        sub_ctrl_x_cpos_ = create_subscription<DynamixelControlXCurrentBasePosition> ("dynamixel/x_cmd/current_position",  4, bind(&DynamixelHandler::CallBackDxlCmd_X_CurrentPosition, this, _1));
        sub_ctrl_x_epos_ = create_subscription<DynamixelControlXExtendedPosition>("dynamixel/x_cmd/extended_position", 4, bind(&DynamixelHandler::CallBackDxlCmd_X_ExtendedPosition, this, _1));
    }
    if ( num_[SERIES_P] > 0) {
        sub_ctrl_p_pos_  = create_subscription<DynamixelControlPPosition>        ("dynamixel/p_cmd/position",          4, bind(&DynamixelHandler::CallBackDxlCmd_P_Position, this, _1));
        sub_ctrl_p_vel_  = create_subscription<DynamixelControlPVelocity>        ("dynamixel/p_cmd/velocity",          4, bind(&DynamixelHandler::CallBackDxlCmd_P_Velocity, this, _1));
        sub_ctrl_p_cur_  = create_subscription<DynamixelControlPCurrent>         ("dynamixel/p_cmd/current",           4, bind(&DynamixelHandler::CallBackDxlCmd_P_Current, this, _1));
        sub_ctrl_p_epos_ = create_subscription<DynamixelControlPExtendedPosition>("dynamixel/p_cmd/extended_position", 4, bind(&DynamixelHandler::CallBackDxlCmd_P_ExtendedPosition, this, _1));
    }
    sub_dxl_commands_    = create_subscription<DxlCommandsX>("dynamixel/command", 10, bind(&DynamixelHandler::CallBackDxlCommand, this, _1));
    ...
    pub_status_ = create_publisher<DynamixelStatus>("dynamixel/status"  , 4);
